...
With the kingdom divided in two parts the normal princess show all her properties and the advantages in statistics to use the Normal family. For example she mention  how the normal distribution is using samples to summarize the entire population.  Most of the population is near an average. She also mention that  without a normal or any "distribution," researchers would have to measure the entire population. If the normal distribution was never discovered.  Therefore there was no sampling theory.  If you were studying sizes of oranges, you had to measure the sizes of ALL of the oranges. You had no idea if the next sample would also be normally distributed.  
